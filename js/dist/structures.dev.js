...
var sphereSize = 1000; // renderers, cameras, etc.

var controls, camera, scene, cssRenderer; // roots and root toggles/trackers 
...
var defaultBioRootMotion = false; // toggles / tracking for education
...
var contractToggle = false; // toggles / tracking for work
...
var workInternToggle = false;
var workMatOpsToggle = false;
var workContractToggle = false; // toggles / tracking for bio

var defaultBioToggle = false; // all objects 

var allObjects = []; // stationary objects

var allStationaryObjects = [];
var menuButtonObjects = []; // education objects 
...
var workContractObjects = []; // bio objects 

var allBioObjects = [];
var defaultBioObjects = []; // positioning object
